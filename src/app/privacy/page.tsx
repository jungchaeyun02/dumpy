  ...
  return (
    <div className="min-h-screen bg-canvas px-6 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-body text-ink">
          <section>
            <h2 className="text-title font-bold text-ink mb-4">1. 수집하는 개인정보</h2>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">2. 개인정보의 이용 목적</h2>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">3. 메모 본문의 처리</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">4. 개인정보의 보관 기간</h2>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">5. 개인정보의 제3자 제공</h2>
            <p>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">6. 개인정보 처리 위탁</h2>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">7. 이용자의 권리</h2>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">8. 만 14세 미만 아동</h2>
            <p>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">9. 개인정보 보호책임자</h2>
            <p>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">10. 시행일</h2>
            <p>이 개인정보 처리방침은 2024년 1월 1일부터 시행됩니다.</p>
          </section>
        </div>

        <div className="mt-8 text-center">
          <a href="/" className="link-quiet text-meta">← 덤피로 돌아가기</a>
        </div>
      </div>
    </div>
  );
