    ...
    <div className="min-h-screen bg-canvas px-6 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-body text-ink">
          <section>
            <h2 className="text-title font-bold text-ink mb-4">제1조 (목적)</h2>
            <p>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">제2조 (서비스의 내용)</h2>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">제3조 (이용 자격)</h2>
            <p>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">제4조 (이용자의 의무)</h2>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">제5조 (서비스의 중단)</h2>
            <p>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">제6조 (메모의 보관)</h2>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">제7조 (면책조항)</h2>
            <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">제8조 (약관의 변경)</h2>
            <p>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">제9조 (분쟁 해결)</h2>
            <p>
          ...
          <section>
            <h2 className="text-title font-bold text-ink mb-4">부칙</h2>
